...
&nbsp;<asp:Label ID="LabelMBRpodnosioca" runat="server" Text="" style="font-weight: 700"></asp:Label>
         ...
         <tr style="text-align: center">
             <td colspan="2">
              <asp:Label ID="labelmsmupis" runat="server" Text="Niste popunili sva polja/You have not completed all required fields" Visible="false" style="color: #FF0000; font-size: medium;"></asp:Label>
             </td>
         </tr>
        <tr>
      ...
      <%--  <tr>
        ...
        <tr style="border-collapse:collapse">
            <td class="okvirlevi">Ime i prezime zaposlenog/Employee first and last name:
                <br />
...
&nbsp;<asp:Label ID="LabelNapomena" runat="server" Text=""></asp:Label>
        ...
        <tr>
            <td class="okvirlevi">Sadašnja org. celina/Current org. unit:</td>
            <td class="okvirdesni">
        ...
        <tr>
            <td class="okvirlevi">Sadašnji posao/Current job:</td>
            <td class="okvirdesni">
        ...
        <tr>
            <td class="okvirlevi">Sadašnji koeficijent/Current coefficient:</td>
            <td class="okvirdesni">
                <asp:Label ID="LabelSadasnjiKoef" runat="server" Text=""></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="okvirlevi"><b>Nova org. celina/New org. unit:</b></td>
            <td class="okvirdesni">
        ...
        <tr>
            <td class="okvirlevi"><b>Novi posao/New job:</b></td>
            <td class="okvirdesni">
        ...
        <tr>
            <td ><b></b></td>
            <td style="border:solid; border-width:1px; padding-left:5px;"><strong>Job code:&nbsp;<asp:TextBox ID="TextBox5" runat="server"></asp:TextBox>
                <asp:Button ID="Button2" runat="server" Text="OK" OnClick="Button2_Click" />
                </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Zahtevani SSS/Qual.level:
        ...
        <tr>
            <td style="border:solid; border-width:1px; padding-left:5px;"><b>Novi koeficijent/New coefficient: </b>
                <asp:TextBox ID="TextBox4" runat="server" CssClass="auto-style4" Width="50px" ></asp:TextBox>

            &nbsp;&nbsp;
                <asp:Label ID="LabelBaznaZarada" runat="server" Text="" style="font-weight: 700"></asp:Label>
&nbsp;<asp:Button ID="Button3" runat="server" Text="Izračunaj baznu zaradu za novi koef." OnClick="Button3_Click" style="font-weight: 700" />
                <br />
                <asp:Label ID="labelmsmnovikeof" runat="server" style="color: #FF0000" Text="* obavezno polje" Visible="false"></asp:Label>
            &nbsp;
                 <asp:RegularExpressionValidator runat="server" ErrorMessage="Dozvoljen je unos decimalnih brojeva sa zarezom" ControlToValidate="TextBox4"
      ValidationExpression="^[1-9]\d*(\,\d+)?$" style="color: #FF0000"></asp:RegularExpressionValidator>
            </td>
            <td>&nbsp;&nbsp;
                <asp:Label ID="Labelddl" runat="server" Text="Predviđeni koeficijent / Predicted coefficient: " Visible="false"></asp:Label>
&nbsp;<asp:DropDownList ID="DropDownList3" runat="server" Visible="false">
        ...
        <tr>
            <td class="auto-style3" colspan="2"><strong>Pomoćnik Generalnog direktora/Deputy General Director</strong><br />
                <asp:Label ID="LabelPomocnikGeneralnog1" runat="server" Text="Lianxi Wang"></asp:Label>
