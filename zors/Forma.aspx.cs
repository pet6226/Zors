...
namespace zors
{
    public partial class Forma : System.Web.UI.Page
    {
        ...
        string cs2 = ConfigurationManager.ConnectionStrings["ConnectionStringUSSKAD"].ConnectionString;


        private ICreationRequestService creationRequestService = new CreationRequestService();

        protected void Page_Load(object sender, EventArgs e)
        {
            LabelMBRpodnosioca.Text = StorageSession.Current.EmployeeId;
            LabelImePodnosioca.Text = StorageSession.Current.Name;
        ...
        {
            Employee employee = this.creationRequestService.GetEmployeeCurrent(TextBox3.Text);

            if (employee is EmployeeNotExist ||
                employee is EmployeeNotExisitngMbr ||
                employee is EmployeeWrongMbr ||
                employee is EmployeeWrongSession)
            {
