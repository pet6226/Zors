                ...
                <p>
                    <asp:GridView ID="GridViewRN1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="mbr_podnosioca" HeaderText="mbr_podnosioca" SortExpression="mbr_podnosioca">
                                <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>

                            <asp:BoundField DataField="ime_podnosioca" HeaderText="ime_podnosioca" SortExpression="ime_podnosioca">
                                <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>

                            <asp:BoundField DataField="mbr" HeaderText="mbr" SortExpression="mbr">
                                <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="datum_podnosenja" HeaderText="datum_podnosenja" DataFormatString="{0:dd.MM.yyyy}" SortExpression="datum_podnosenja">
                                <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>
...
&nbsp;<asp:Label ID="LabelPomocnikGeneralnogMB2" runat="server" Text="42880"></asp:Label>
        ...
        <tr>
            ...
            &nbsp;
                ...
                <br />
                <br />
                <asp:Button ID="ButtonODOBRI" runat="server" Text="ODOBRI / APPROVE" Width="190px" style="color: #006600; font-weight: 700" />
